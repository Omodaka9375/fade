...
@torch.no_grad()
def measure_fade_tps(
    model, tokenizer, preset: str = "balanced", decode_tokens: int = DECODE_TOKENS
):
...
def main():
    ...
    print(f"\n{'=' * 60}")
    print("Notes:")
    print("  - Steady-state: decode steps WITHOUT reassignment")
    print("  - Reassign-step: decode steps WITH tier reassignment")
    print("  - Amortized: overall TPS including reassignment cost")
